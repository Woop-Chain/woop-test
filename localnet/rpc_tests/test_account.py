...
def account_test_tx():
    ...
    """
    test_tx = {
        "from": "woc1v92y4v2x4q27vzydf8zq62zu9g0jl6z0lx2c8q",
        "to": "woc1s92wjv7xeh962d4sfc06q0qauxak4k8hh74ep3",
        "amount": "1000",
        "from-shard": 0,
        "to-shard": 0,
...
def test_get_transactions_count(account_test_tx):
    ...
    # Check v1, SENT
    raw_response = base_request("wiki_getTransactionsCount",
    ...
    # Check v2, SENT
    raw_response = base_request("wikiv2_getTransactionsCount",
                                params=[account_test_tx["to"], "SENT"],
                                endpoint=endpoints[account_test_tx["shardID"]])
    response = check_and_unpack_rpc_response(raw_response, expect_error=False)
    assert_valid_json_structure(reference_response, response)
...
def test_get_transactions_history_v1():
    ...
    # Check short tx
    raw_response = base_request("wiki_getTransactionsHistory",
                                params=[{
                                    "address": address,
                                    "pageIndex": 0,
                                    "pageSize": 1000,
...
def test_get_transactions_history_v2():
    ...
    # Check short tx
    raw_response = base_request("wikiv2_getTransactionsHistory",
                                params=[{
                                    "address": address,
                                    "pageIndex": 0,
                                    "pageSize": 1000,
...
def test_get_balances_by_block_number_v1(account_test_tx):
    ...
    raw_response = base_request("wiki_getBalanceByBlockNumber",
...
def test_get_balances_by_block_number_v2(account_test_tx):
    ...
    raw_response = base_request("wikiv2_getBalanceByBlockNumber",
