...
initial_funding = [
    ...
    },
    {
        ...
        "from": "woc1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur",
        "to": "woc1ue25q6jk0xk3dth4pxur9e742vcqfwulhwqh45",
    ...
    },
    {
        ...
        "from": "woc1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur",
        "to": "woc19l4hghvh40fyldxfznn0a3ss7d5gk0dmytdql4",
    ...
    },
    {
        ...
        "from": "woc1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur",
        "to": "woc1twhzfc2wr4j5ka7gs9pmllpnrdyaskcl5lq8ye",
    ...
    },
    {
        ...
        "from": "woc1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur",
        "to": "woc1u57rlv5q82deja6ew2l9hdy7ag3dwnw57x8s9t",
    ...
    },
    {
        ...
        "from": "woc1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur",
        "to": "woc1pvkjamc0q96s6z62qzz6e09k2qrqqdj34ylxvd",
    ...
    },
    {
        ...
        "from": "woc1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur",
        "to": "woc13lu674f3jkfk2qhsngfc2vhcf372wprctdjvgu",
    ...
    },
    {
        ...
        "from": "woc1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur",
        "to": "woc1ujsjs4mhds75xnws0yx0v8l2rvyp67arwzqrvz",
    ...
    },
    {
        ...
        "from": "woc1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur",
        "to": "woc156wkx832t0nxnaq6hxawy4c3udmnpzzddds60a",
    ...
    },
    {
        ...
        "from": "woc1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur",
        "to": "woc109r0tns7av5sjew7a7fkekg4fs3pw0h76pp45e",
    ...
    },
    {
        ...
        "from": "woc1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur",
        "to": "woc1nmy8quw0924fss4r9km640pldzqegjk4wv4wts",
    ...
    },
    {
        ...
        "from": "woc1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur",
        "to": "woc1v895jcvudcktswcmg2sldvmxvtvvdj2wuxj3hx",
    ...
    },
    {
        ...
        "from": "woc1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur",
        "to": "woc13v9m45m6yk9qmmcgyq603ucy0wdw9lfsxzsj9d",
    ...
    },
    {
        ...
        "from": "woc1zksj3evekayy90xt4psrz8h6j2v3hla4qwz4ur",
        "to": "woc13muqj27fcd59gfrv7wzvuaupgkkwvwzlxun0ce",
...
def send_transaction(tx_data, confirm_submission=False):
    ...
    # Send tx
    response = base_request('wiki_sendRawTransaction', params=[tx_data["signed-raw-tx"]],
...
def send_staking_transaction(tx_data, confirm_submission=False):
    ...
    # Send tx
    response = base_request('wiki_sendRawStakingTransaction', params=[tx_data["signed-raw-tx"]],
...
def get_transaction(tx_hash, shard):
    ...
    raw_response = base_request('wiki_getTransactionByHash', params=[tx_hash], endpoint=endpoints[shard])
...
def get_staking_transaction(tx_hash):
    ...
    """
    assert isinstance(tx_hash, str), f"Sanity check: expect tx hash to be of type str not {type(tx_hash)}"
    raw_response = base_request('wiki_getStakingTransactionByHash', params=[tx_hash], endpoint=endpoints[0])
    return check_and_unpack_rpc_response(raw_response, expect_error=False)
...
def assert_valid_test_from_address(address, shard, is_staking=False):
    ...
    assert account.is_valid_address(address), f"{address} is an invalid WOC address"
    if not account.get_balance(address, endpoint=endpoints[shard]) >= 1e18:
        raise AssertionError(f"Account {address} does not have at least 1 WOC on shard {shard}")
